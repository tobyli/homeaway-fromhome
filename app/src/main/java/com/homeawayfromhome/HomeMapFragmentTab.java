...
public class HomeMapFragmentTab extends Fragment {
    ...
    public HomeMapFragmentTab(RootMap rootActivity){
        this.rootActivity = rootActivity;
    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState){
        View rootView = inflater.inflate(R.layout.activity_home_map, container, false);
        this.rootView = rootView;
        mBarTextView = (TextView) rootView.findViewById(R.id.bar_textview);
        mBarTextView.setText("Madison");
